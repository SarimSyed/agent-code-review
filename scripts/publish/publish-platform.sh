...
PLATFORMS=(
  "darwin-arm64:acr-darwin-arm64:acr"
  "darwin-x64:acr-darwin-amd64:acr"
  "linux-arm64:acr-linux-arm64:acr"
  "linux-x64:acr-linux-amd64:acr"
  "win32-arm64:acr-windows-arm64.exe:acr.exe"
  "win32-x64:acr-windows-amd64.exe:acr.exe"
)
...
# Derive scope override from ACR_PKG_NAME (e.g. @ali/open-code-review → @ali)
SCOPE_OVERRIDE=""
if [ -n "${ACR_PKG_NAME:-}" ]; then
    SCOPE_OVERRIDE="${ACR_PKG_NAME%%/*}"
fi
