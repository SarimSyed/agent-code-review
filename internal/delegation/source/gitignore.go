...
// providers should always skip. Exposed so other local consumers can reuse the
// same blocklist.
...
// gitignore-style pattern, using the simplified semantics that the Git diff provider
